...
## Part 2A: Leader Election (due March 24)
...
ok      raft    10.187s
```
Side notes: 1. Delete "-race" to get rid of data race warning. 2. Add "-count n" to test the program n times.

```
$ go test -run 2A
$ go test -run 2A -count 10 // run the test 10 times
```
